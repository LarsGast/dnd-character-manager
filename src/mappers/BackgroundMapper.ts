...
import { BackgroundApiDto, BackgroundFeatureApiDto } from "../types/api/resources/BackgroundApiDto.js";
import { BaseResourceApiDto } from "../types/api/wrappers/BaseResourceApiDto.js";
import { Choice } from "../types/domain/helpers/Choice.js";
import { Background, BackgroundFeature } from "../types/domain/resources/Background.js";
...
export class BackgroundMapper implements IMapper<BackgroundApiDto, Background> {
    ...
    public map(source: BackgroundApiDto): Background {
        return {
            ...
            starting_equipment: source.starting_equipment.map(startingEquipment => this.baseResourceMapper.map(startingEquipment)),
            starting_equipment_options: this.choiceMapper.map(source.starting_equipment_options),
    ...
    public mapBackgroundFeature(source: BackgroundFeatureApiDto): BackgroundFeature {
        return {
            name: source.name,
            desc: source.desc
        };
