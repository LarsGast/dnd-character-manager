...
import { ClassLevelApiDto, SpellcastingApiDto } from "../types/api/resources/ClassLevelApiDto.js";
import { BaseResourceApiDto } from "../types/api/wrappers/BaseResourceApiDto.js";
import { ClassLevel, Spellcasting } from "../types/domain/resources/ClassLevel.js";
...
export class ClassLevelMapper implements IMapper<ClassLevelApiDto, ClassLevel> {
    ...
    public map(source: ClassLevelApiDto): ClassLevel {
        return {
            ...
            features: source.features.map(feature => this.baseResourceMapper.map(feature)),
