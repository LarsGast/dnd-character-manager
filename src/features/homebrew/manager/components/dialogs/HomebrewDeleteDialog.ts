...
export class HomebrewDeleteDialog extends HTMLDialogElement {
	...
	constructor() {
		...
		this.warningText.textContent =
			'Warning: deleting this object will remove all data for the selected object. Consider exporting the object first to create a backup if you do not want to lose any data. This data cannot be recovered once deleted.';
...
customElements.define('homebrew-object-delete-dialog', HomebrewDeleteDialog, {
	extends: 'dialog',
});
