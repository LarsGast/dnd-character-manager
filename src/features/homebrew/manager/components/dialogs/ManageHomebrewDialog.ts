...
export class ManageHomebrewDialog extends HTMLDialogElement {
	...
	constructor() {
		...
		this.firstParagraph = getElementWithTextContent(
			'p',
			'Since this page only has access to the SRD, the class, subclass, race, background, or other content that you might want to add to your characters might not be available. Thats why, in this menu, you can create your own objects as homebrew.',
		);
...
customElements.define('manage-homebrew-dialog', ManageHomebrewDialog, {
	extends: 'dialog',
});
